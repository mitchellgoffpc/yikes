...
def test_global_type_resolution(subtests: pytest.Subtests) -> None:
    cases = [
        ...
        ("struct S; struct S *p;",
         {"idents": {"p": AST.PointerType(AST.StructType(_id("S"), None))},
          "tags": {"S": AST.StructType(_id("S"), None)}}),
        ("struct S; struct S { int x; }; struct S s;",
         {"idents": {"s": AST.StructType(_id("S"), [AST.Field(_id("x"), _bt("int"), None)])},
          "tags": {"S": AST.StructType(_id("S"), [AST.Field(_id("x"), _bt("int"), None)])}}),
        ...
        {"idents": {"S": AST.StructType(_id("S"), [AST.Field(_id("x"), _bt("int"), None)]),
          ...
          "tags": {"S": AST.StructType(_id("S"), [AST.Field(_id("x"), _bt("int"), None)])}}),
        ("typedef int T; struct S { T x; T a[3]; };",
         {"idents": {},
          "tags": {"S": AST.StructType(
              _id("S"),
              [AST.Field(_id("x"), _bt("int"), None), AST.Field(_id("a"), AST.ArrayType(_bt("int"), AST.IntLiteral(3)), None)],
          )}}),
        ("typedef int T; T (*fp)(T*);",
         {"idents": {"T": _bt("int"),
                     "fp": AST.PointerType(AST.FunctionType(_bt("int"), [AST.Param(None, AST.PointerType(_bt("int")))], False))},
          "tags": {}}),
        ("typedef int T; T (*arr[2])(int);",
         {"idents": {"T": _bt("int"),
                     "arr": AST.ArrayType(AST.PointerType(AST.FunctionType(_bt("int"), [AST.Param(None, _bt("int"))], False)), AST.IntLiteral(2))},
          "tags": {}}),
        ("typedef int T(); T f;",
         {"idents": {"T": AST.FunctionType(_bt("int"), [], False), "f": AST.FunctionType(_bt("int"), [], False)}, "tags": {}}),
...
def test_external_decl_errors(subtests: pytest.Subtests) -> None:
    cases = [
        ...
        ("struct S { int f(); };", r"Invalid field type at \d+:\d+"),
        ("struct S; struct T { struct S s; };", r"Invalid field type at \d+:\d+"),
        ...
        ("enum E { A = 1, B = A + 1 };", r"Enumerator value is not a constant expression at \d+:\d+"),
